...
The square also says what comes next. Row 2 of [the copies picture from
bridge three](#the-copies-what-sampling-does-to-a-spectrum) — separated
copies, the original spectrum intact inside each — is the entire proof
of the theorem with three names, waiting to be written carefully: what "band-limited" must mean, why the boundary case bites, how
