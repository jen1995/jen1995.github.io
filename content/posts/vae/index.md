...
What fixes this is precisely a *non*-factorized, autoregressive prior $p(z)=\prod_i p(z_i \mid z_{<i})$ (PixelCNN, and in DALL-E — the Transformer), which does capture the dependencies between positions.
